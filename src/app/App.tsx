...
export default function App() {
  ...
  return (
    <div className="dark min-h-screen bg-[#070A07]">
      {/* Main Content */}
          ...
          <div className="grid grid-cols-4 h-24">
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 transition-colors ${
                activeTab === "home" ? "text-[rgb(var(--q-text))]" : "text-[rgb(var(--q-text))]/60 hover:text-[rgb(var(--q-text))]/80"
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 transition-colors ${
                activeTab === "trending" ? "text-[rgb(var(--q-text))]" : "text-[rgb(var(--q-text))]/60 hover:text-[rgb(var(--q-text))]/80"
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 transition-colors ${
                activeTab === "portfolio" ? "text-[rgb(var(--q-text))]" : "text-[rgb(var(--q-text))]/60 hover:text-[rgb(var(--q-text))]/80"
              }`}
            >
            ...
            <button
              ...
              className={`relative flex flex-col items-center justify-center gap-1 transition-colors ${
                activeTab === "airdrop" ? "text-[rgb(var(--q-text))]" : "text-[rgb(var(--q-text))]/60 hover:text-[rgb(var(--q-text))]/80"
              }`}
            >
              <Gift className="w-5 h-5" />
              <span className="text-xs">Rewards</span>
              {/* small pulse dot */}
              <div className="absolute top-2 right-8 w-2 h-2 bg-[rgb(var(--q-primary))] rounded-full" />
            </button>
          </div>
        </div>
      </div>
